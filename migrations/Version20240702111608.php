 ...
 */
final class Version20240702111608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, professeur_principal_id INT DEFAULT NULL, designation VARCHAR(255) DEFAULT NULL, classe INT NOT NULL, section VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8F87BF961BF3D36A (professeur_principal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE matiere (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(255) NOT NULL, coefficient DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, eleve_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, mode_paiement VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_B1DC7A1EA6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, parents_id INT DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, roles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, prenom VARCHAR(50) DEFAULT NULL, nom VARCHAR(50) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, sexe VARCHAR(1) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, numero_telephone VARCHAR(50) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, post_nom VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, identification_nationale VARCHAR(255) DEFAULT NULL, fonction VARCHAR(50) DEFAULT NULL, matricule VARCHAR(50) DEFAULT NULL, INDEX IDX_1D1C63B38F5EA509 (classe_id), INDEX IDX_1D1C63B3B706B6D3 (parents_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
